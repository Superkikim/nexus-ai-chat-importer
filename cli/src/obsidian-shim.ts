...
export class Scope {}
// eslint-disable-next-line @typescript-eslint/no-empty-object-type, @typescript-eslint/no-unused-vars -- stub interface; _T is unused by design in this shim
export interface ISuggestOwner<_T> {}

...
3. **Import**: Click the <img src="https://api.iconify.design/lucide:message-square-plus.svg" width="16" height="16" alt="message-square-plus" /> ribbon icon in the left sidebar or use command palette → "Import AI conversations"
